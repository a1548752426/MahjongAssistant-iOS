...
- 上方全局弃牌区会同步到“已见牌”，用于剩余进张计算
- 下方为手牌区，副露默认放在右下橙色区域，也可切换到左边
...
3. 黄线上方放全局已经打出的牌；黄线下方放自己的手牌。
4. 把亮出的碰/杠牌放在右下橙色区域，可调整橙色区域宽度或切换到左边。
5. 暗杠若有两张同牌朝上，会自动把另外两张盖牌补齐；如果四张全部盖住，点击“全盖暗杠＋”选择牌种。
6. 连续两帧识别稳定后，应用会同步手牌、副露和全局弃牌；绿色粗框和顶部文字表示建议打出的牌。
